<script lang="ts">
  ...
  let currentThumb: null = null
  let holding = false
  let thumbHover = false
  let keydownAcceleration = 0
  let accelerationTimer: string | number | NodeJS.Timeout | null | undefined = null
  ...
  function isMouseInElement(event: { clientX: any; clientY: any }, element: { getBoundingClientRect: () => any }) {
  ...
  function updateValueOnEvent(e: { type: string; stopPropagation: () => void; preventDefault: () => void; touches: { clientX: any }[]; clientX: any }) {
